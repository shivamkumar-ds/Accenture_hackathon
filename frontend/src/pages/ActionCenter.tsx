          ...
          {counts.total > 0 && (
            ...
            {remediation.qualification_gaps.length > 0 && (
              <RemediationSection
                ...
                note="Requirements where BidOps found insufficient company capability evidence. Best resolved by adding real capability evidence -- an administrator can also record an audited Pass override if the evidence will be arranged before submission."
              >
            ...
            {/* "Needs Your Review" -- single merged heading over
                ...
                they mean different things: coverage_gaps is "BidOps can't
              ...
              <Card className="border-warning/30">
                ...
                {remediation.coverage_gaps.length > 0 && (
                  <div className="px-6 pt-1 pb-2">
                    <p className="text-xs font-semibold text-muted-foreground mb-1">
                      BidOps can't evaluate this domain ({remediation.coverage_gaps.length})
                    </p>
                ...
                {remediation.human_review_items.length > 0 && (
                  <div className={cn("px-6 pt-3 pb-2", remediation.coverage_gaps.length > 0 && "border-t border-border")}>
                    ...
                    <p className="text-xs text-muted-foreground/80 mb-2">
                      BidOps found relevant capability evidence but couldn't establish a sufficiently clear match.
                    </p>
                  </div>
                )}
                {remediation.human_review_items.length > 0 && (
